...
var NOTES_POPOVER = function($) {
    ...
    $(document).on('shown.bs.modal', function() {
        ...
        if(typeof PDF_NOTES_HELPER !== 'undefined') {
            // fill the textarea with a page marker if the comment is added as
            // the result of a click on the PDF previewer
            var fill = PDF_NOTES_HELPER.getTextAreaFill();
            if(fill !== null) {
                $('#comment-textarea').val(fill);
