...
class TestExtractNotes(InvenioTestCase):
    ...
    def test_extract_notes_from_comment(self):
        ...
        self.assert_(fun('P.1,2,3: lorem ipsum dolor', True) ==
                     [{'where': {'marker': 'P.1,2,3'},
                       'what': 'lorem ipsum dolor'}])
        self.assert_(fun('P.1-3: lorem ipsum dolor', True) ==
                     [{'where': {'marker': 'P.1-3'},
                       'what': 'lorem ipsum dolor'}])
        self.assert_(fun('P.1-3,4: lorem ipsum dolor', True) ==
                     [{'where': {'marker': 'P.1-3,4'},
                       'what': 'lorem ipsum dolor'}])
        ...
        self.assert_(fun('F.1a: lorem ipsum dolor', True) ==
                     [{'where': {'marker': 'F.1a'},
                       'what': 'lorem ipsum dolor'}])
        self.assert_(fun('F.1-3: lorem ipsum dolor', True) ==
                     [{'where': {'marker': 'F.1-3'},
                       'what': 'lorem ipsum dolor'}])
        ...
        self.assert_(fun('L.1: lorem ipsum dolor', True) ==
                     [{'where': {'marker': 'L.1'},
                       'what': 'lorem ipsum dolor'}])
        self.assert_(fun('L.1-3: lorem ipsum dolor', True) ==
                     [{'where': {'marker': 'L.1-3'},
                       'what': 'lorem ipsum dolor'}])
    ...
    def test_prepare_notes(self):
        ...
        tree = PREPARE_NOTES([
            ...
            {'where': {'marker': 'P.1-F.2a'}, 'what': 'ipsum'},
            {'where': {'marker': 'G'}, 'what': 'dolor'},
            {'where': {'marker': 'G'}, 'what': 'elit'},
            {'where': {'marker': 'G-T.4'}, 'what': 'adipisicing'},
        ...
        self.assert_(tree['P.1']['F.2a']['path'] == 'P.1-F.2a')
        self.assert_(tree['P.1']['F.2a']['leaf'][0]['what'] == 'ipsum')
        self.assert_(len(tree['G']['leaf']) == 2)
        self.assert_(tree['G']['T.4']['path'] == 'G-T.4')
